...
namespace TCIIPChart.ViewModel
{
    public class ChartServer
    {
        ...
        public ChartServer()
        {
            this.ConnectBtnClick = new DelegateCommand<object>(this.AsyncServerStart, Cansubmit);            
        }
        ...
        public void ServerStart()
        {
            ...
            client.GetStream().BeginRead(byteData, 0, byteData.Length, new AsyncCallback(DataReceived),byteData);
